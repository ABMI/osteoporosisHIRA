...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (75910,4264281,443392)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (75910,4264281,443392)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1524674,1511646,1521987,1511251,1513103,44506794,21604156,21604151,21602783,1501781,21602625,21602626,40222444,21604169)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1524674,1511646,1521987,1511251,1513103,44506794,21604156,21604151,21602783,1501781,21602625,21602626,40222444,21604169)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1516800,1557272,1512480,21604155,21604154,21604160,21604152,45893276)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1516800,1557272,1512480,21604155,21604154,21604152)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (435093,77129,4170742,441974,441422,4230399)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (435093,77129,4170742,441974,441422,4230399)
  and c.invalid_reason is null
...
--------------------------------------------------------- bisphosphonate extra code
UPDATE #CodeSetData_19
...
when drug_source_value IN ('642306871', '644308541', '644501971', '644602911', '644913971', '645000320', '645000321', '645304621', '645604241', '645906021', '648103561', '648203631', '648506911', '649506261', '650303071', '653005911', '653402881', '654004271', '655604831', '657202481', '657805921', '669804231', '669906741', '670104201', '670606941', '693901651', '058800401', '059000621', '621803931', '625201711', '640903671', '641806831', '644308540', '644501970', '644602910', '644913970', '645000290', '645000300', '645304620', '645604240', '647205431', '648103560', '648203630', '648506910', '649103381', '649506260', '649605091', '650303070', '652105130', '652105131', '652105751', '653402880', '654004270', '657202480', '657307221', '657503611', '658107311', '658204091', '658604361', '659901241', '660703481', '661305601', '665507451', '669605231', '669804230', '670001750', '670606940', '670701710', '670701711', '683101351', '690300461', '693901650', '694002861', '697100921', 'E01840781', 'E01840782', 'E01840841') THEN  dateadd(day, quantity*90-1, drug_exposure_start_date)
...
from #CodeSetData_19 C
JOIN @cdm_database_schema.PERSON P on C.person_id = P.person_id
WHERE YEAR(C.drug_exposure_start_date) - P.year_of_birth >= 50
AND C.ordinal = 1
...
TRUNCATE TABLE #CodeSetData_20;
DROP TABLE #CodeSetData_20;
